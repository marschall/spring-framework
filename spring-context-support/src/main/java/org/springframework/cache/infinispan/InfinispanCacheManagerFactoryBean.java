...
/**
 * {@link FactoryBean} for a Infinispan {@link org.infinispan.manager.EmbeddedCacheManager}.
 *
 * <p>This class is intended to be used in conjunction with Spring XML configuration and
 * Infinispan XML configuration. While it does work with Spring Java configuration in such
 * cases you're likely better off instantiating the cache manager yourself and using
 * <a href="https://docs.jboss.org/author/display/ISPN/Configuring+cache+programmatically">
...
public class InfinispanCacheManagerFactoryBean
        implements FactoryBean<org.infinispan.manager.EmbeddedCacheManager>, InitializingBean, DisposableBean {
